...
const COULEURS_CATEGORIES: Record<string, string> = {
  ...
  loyer: "bg-amber-900/50 text-amber-400",
  electricite: "bg-yellow-900/50 text-yellow-400",
  eau: "bg-sky-900/50 text-sky-400",
  gaz: "bg-orange-900/50 text-orange-400",
  forfait_tel: "bg-violet-900/50 text-violet-400",
  box_internet: "bg-blue-900/50 text-blue-400",
  assurances: "bg-slate-800/50 text-slate-300",
