...
> = {
  ...
  loyer: {
    noms: ["loyer mensuel", "agence immobiliere", "taxe fonciere"],
    min: 500,
    max: 950,
  },
  electricite: {
    noms: ["edf", "engie electricite", "totalenergies elec"],
    min: 40,
    max: 120,
  },
  eau: {
    noms: ["veolia", "suez", "eau de paris"],
    min: 20,
    max: 60,
  },
  gaz: {
    noms: ["engie gaz", "totalenergies gaz", "eni"],
    min: 30,
    max: 100,
  },
  forfait_tel: {
    noms: ["free mobile", "orange", "sfr", "bouygues telecom"],
    min: 10,
    max: 40,
  },
  box_internet: {
    noms: ["free box", "orange fibre", "sfr box", "bouygues bbox"],
    min: 20,
    max: 50,
  },
  assurances: {
    noms: ["axa", "maif", "matmut", "groupama", "allianz"],
    min: 30,
    max: 150,
  },
  loisirs: {
