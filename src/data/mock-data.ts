...
> = {
  alimentation: {
    noms: ["carrefour", "leclerc", "auchan", "lidl", "monoprix", "picard"],
    min: 8,
    max: 180,
  },
  transport: {
    noms: ["uber", "bolt", "ratp", "sncf", "totalenergies", "shell"],
    min: 5,
    max: 120,
  },
  logement: {
    noms: ["loyer mensuel", "edf", "engie", "veolia", "free box"],
    min: 30,
    max: 950,
  },
  loisirs: {
    noms: ["fnac", "cultura", "ugc", "pathe", "decathlon"],
    min: 10,
    max: 150,
  },
  sante: {
    noms: ["pharmacie lafayette", "doctolib", "optical center", "allianz"],
    min: 10,
    max: 200,
  },
  restauration: {
  ...
  epargne: {
    noms: ["livret a", "assurance vie", "pea", "crypto"],
    min: 50,
    max: 500,
  },
  divers: {
